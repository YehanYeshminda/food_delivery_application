...
const Header = () => {
	...
	// setting the logout function in order to clear the session and to set the login user to null
	const logout = () => {
		setIsMenu(false);
		localStorage.clear();
			...
			<div className="hidden md:flex w-full h-full items-center justify-between">
				...
				<div className="flex items-center gap-8">
					...
					<div
						...
						onClick={showCart}
					>
						{/* will only load if the cart item array length is greater than 0 */}
					...
					<div className="relative">
						...
						{isMenu && (
							<motion.div
								...
								className="w-40 bg-gray-100 shadow-xl rounded-lg absolute top-12 right-0 flex flex-col"
							>
								{user && user.email === 'yeshanyesh12@gmail.com' && (
									<Link to={'/createItem'}>
										<p
				...
				<div className="relative">
					...
					{isMenu && (
						...
						>
							...
							<p
								className="m-2 p-2 rounded-md shadow-md flex items-center gap-3 cursor-pointer hover:bg-slate-300 justify-center bg-slate-200 transition-all duration-100 ease-in-out text-textColor text-base"
								onClick={logout}
							>
								Logout <MdLogout />
							</p>
